        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LaboratoryOrders_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LaboratoryOrders_LaboratoryTests_LaboratoryTestId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TreatmentPlan = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LaboratoryResults_LaboratoryOrders_LaboratoryOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LaboratoryOrders_AppointmentId",
                table: "LaboratoryOrders",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_LaboratoryOrders_LaboratoryTestId",
                table: "LaboratoryOrders",
                column: "LaboratoryTestId");

            migrationBuilder.CreateIndex(
                name: "IX_LaboratoryOrders_PublicId",
                table: "LaboratoryOrders",
                column: "PublicId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LaboratoryResults_LaboratoryOrderId",
                table: "LaboratoryResults",
                column: "LaboratoryOrderId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LaboratoryResults_PublicId",
                table: "LaboratoryResults",
                column: "PublicId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LaboratoryTests_PublicId",
                table: "LaboratoryTests",
                column: "PublicId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionItems_PublicId",
                table: "PrescriptionItems",
                column: "PublicId",
                unique: true);
